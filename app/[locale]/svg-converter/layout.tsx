...
export const metadata: Metadata = {
  title: 'SVG Converter - Free Online Tool to Convert SVG',
  ...
  keywords: 'svg converter, svg to png, svg to jpeg, svg to ico,svg to image, convert svg files, svg transformation',
  openGraph: {
